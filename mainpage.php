...
<div class="container-fluid" style="background-color: blue">
    <div class="row">
      ...
      <div class="col-11 bgcolor="red"> <h4 align="right" style="color: red; background-color: red" class="rounded-pill" > St Aloysius Gents Hostel</h4>
     <!-- <button type="button" class= btn btn-primary btn-lg btn-block" style="background-color: red" align="right">yes</button>-->
      <div class="container-fluid" style="background-color: red" class="rounded">
    <div class="row">
      <div class="col-8"><h3 style="color: white; background-color: blue; padding-left: 30px" class="rounded-pill"> St Aloysius Gents Hostel</h3></div>
   
      <div class="col-1" >
      <a href="mainpage.php" class="trigger-btn">
        <button type="button" class="btn btn-primary">Home</button></a>
      </div>
      <div class="col-1">
        <div>
        <!-- Button HTML (to Trigger Modal) -->
        <a href="#myModal" class="trigger-btn" data-toggle="modal"> <button type="button" class="btn btn-primary">Login</button></a><br>
        </div></div>

      <div class="col-1">
      <a href="about.html" class="trigger-btn">
        <button type="button" class="btn btn-primary">About</button></a>
      </div>
      <div class="col-1">
      <a href="contact.html" class="trigger-btn">
        <button type="button" class="btn btn-primary">Contact</button></a>
