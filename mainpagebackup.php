...
<div class="container-fluid" style="background-color: cyan;">
    ...
    <div class="row" style="background-color: blue; ">
       ...
       <div class="col-xs-3">
        <div class="">
        <div class="column" style="background-color: red; height: 580px; margin-right: 0px">
                        <div class="row-xs-1"><!--<h4 style="color: white;  padding-left: 120px; padding-right: 50px;">
                            Notifications</h4>-->
                            <br>
                        </div>
                        <div class="row-xs-2">
                            <h3 style="color: white; background-color: blue; padding-left: 115px; padding-right: 50px;"  class="rounded-pill"> Notifications</h3>
                        </div>
                        <div class="row-xs-9">
