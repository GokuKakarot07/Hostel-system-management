...
<div class="login-page">
  <div class="form">
    ...
    <form class="login-form" method="post" action="admindashboard.php">
      ...
      <br>
      <br>
      <button type="button" name="back" class="btn btn-primary btn-lg btn-block login-btn"><a href="mainpage2.php">Go Back to mainpage</a></button>
    </form>
  </div>
</div>
<!-- partial -->
